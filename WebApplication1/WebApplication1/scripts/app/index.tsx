...
let friendData: Friends.IFriendProps[] = [
...
let friends: Friends.Friends =  ReactDOM.render(<Friends.Friends initialData={friendData} />, document.getElementById("friendsNode")) as Friends.Friends;
friends.getData();
